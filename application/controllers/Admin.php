    ...
    public function login(){
			...
			if($this->form_validation->run() === FALSE){
				...
				if($admin_id){
					...
					$this->session->set_flashdata('admin_loggedin', 'You have succesfully logged in as an ADMIN!');
		...
		public function update(){
			...
			if($this->form_validation->run()=== FALSE){
				...
				$this->admin_model->update($enc_password,$admin_id);
		...
		public function edit_user(){
			...
			if($this->form_validation->run()){
				$test = $this->admin_model->update_user($user_id);
