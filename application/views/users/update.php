<style>
  ...
  <div class="menu">
    <center>
      <a style="background-color:#f8f9fa" href="<?php echo base_url('users/update');?>" >My Profile</a>
    ...
    <div class="tocenter">
      <div style="margin-botoom: 5%;"></div><?php if($this->session->flashdata('user_loggedin')): ?>
